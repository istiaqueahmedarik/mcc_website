...
const {
  ...
  getUserTeams,
  getTeamsByVjudgePublic,
  getTeamsCoachedByVjudgePublic,
  deleteCollection,
...
route.post("/admin/rename", adminRenameCollection);
route.post("/admin/copy", adminCopyCollection);
...
route.get(
  "/participation/active-collections",
  listActiveParticipationCollections,
);

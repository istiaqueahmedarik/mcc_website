// Source: https://www.heroicons-animated.com/r/video-camera-slash.json (MIT; see ../LICENSE)
"use client";
...
interface VideoCameraSlashIconProps extends HTMLAttributes<HTMLSpanElement> {
  size?: number;
}

// Source: https://www.heroicons-animated.com/r/rectangle-stack.json (MIT; see ../LICENSE)
"use client";
...
interface RectangleStackIconProps extends HTMLAttributes<HTMLSpanElement> {
  size?: number;
}

// Source: https://www.heroicons-animated.com/r/question-mark-circle.json (MIT; see ../LICENSE)
"use client";
...
interface QuestionMarkCircleIconProps extends HTMLAttributes<HTMLSpanElement> {
  size?: number;
}

// Source: https://www.heroicons-animated.com/r/exclamation-circle.json (MIT; see ../LICENSE)
"use client";
...
interface ExclamationCircleIconProps extends HTMLAttributes<HTMLSpanElement> {
  size?: number;
}

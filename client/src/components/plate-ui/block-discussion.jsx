...
import { createZustandStore, PathApi, TextApi } from '@udecode/plate';
...
export const discussionStore = createZustandStore({
...
export const useFakeUserInfo = (userId) => {
  const mockUsers = [
    {
      id: 'user1',
...
const BlockCommentsContent = ({
  ...
  const sortedMergedData = [...resolvedDiscussions, ...resolvedSuggestion].sort((a, b) => a.createdAt.getTime() - b.createdAt.getTime());

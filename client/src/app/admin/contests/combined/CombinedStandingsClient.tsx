      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 w-full">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-3 w-full sm:w-auto">
          <Link
            ...
            className="flex items-center justify-center gap-2 w-full sm:w-auto px-4 py-3 bg-slate-900 hover:bg-slate-800 text-slate-300 hover:text-white font-bold text-sm rounded-2xl border border-slate-800 transition-all shrink-0 shadow-lg shadow-slate-950/10"
          >

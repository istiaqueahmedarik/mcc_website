...
import TrainerFormsClient from "./TrainerFormsClient";

export const metadata = {
  title: "Trainer Forms | MCC",
  description: "Build, publish, and review trainer forms for classroom workflows.",
};
